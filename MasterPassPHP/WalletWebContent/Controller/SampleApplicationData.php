	...
	public function __construct()
	{
		...
		else
		{
			$profileConfigFile = dirname(__DIR__) . "/" .
								SampleApplicationData::RESOURCES_PATH . 
								SampleApplicationData::PROFILE_PATH . 
								SampleApplicationData::DEFAULT_PROFILE . 
								SampleApplicationData::CONFIG_SUFFIX;
		}
