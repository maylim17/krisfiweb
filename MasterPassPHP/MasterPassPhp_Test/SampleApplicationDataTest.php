...
class SampleApplicationDataTest extends PHPUnit_Framework_TestCase
{
	...
	/*
	 * This tests the constructor method for SampleApplicationData, with no parameters.
	...
	*/
	...
	/*
	 * This tests the constructor method for SampleApplicationData, passing in the config file.
	...
	*/
	public function testConstructorBuildsCallbackPathFromSpecifiedConfigFile() {
		$SAD = new SampleApplicationData(dirname(__FILE__) . "\TestConfig.ini");
	...
	/*
	 * This tests the constructor method for SampleApplicationData, passing in a test config file.
