...
require_once dirname(__DIR__) . '\WalletWebContent\Controller\SampleApplicationHelper.php';
require_once dirname(__DIR__) . '\Common\Connector.php';


class SampleApplicationHelperTest extends PHPUnit_Framework_TestCase
{
	...
	*/
	public function testFormatXML() {		
		...
		$return = SampleApplicationHelper::formatXML($resources);
	...
	public function testFormatError() {
		...
		$return = SampleApplicationHelper::formatError($message);
	...
	public function testFormatResource_ForCheckout() {
		...
		$return = SampleApplicationHelper::formatResource($resources);
